...
const PopularPathCard = ({ pathName, description, whyItsPopular, textColorOfWhyItsPopular, benefit}: PopularPathCardProps) => {
  return (
    <div className='group bg-background flex flex-col  p-5 sm:w-75 h-70 rounded-xl border border-white/20 hover:shadow-sm hover:shadow-primary transition-colors duration-500 '>
